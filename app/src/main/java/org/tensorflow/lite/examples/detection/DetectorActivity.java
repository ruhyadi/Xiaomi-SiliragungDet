...
public class DetectorActivity<ResultTracker> extends CameraActivity implements OnImageAvailableListener {
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    sensorOrientation = (rotation - getScreenOrientation())*-1;
    ...
    //tambahan
    statusMasker = (TextView) findViewById(R.id.status_masker);
